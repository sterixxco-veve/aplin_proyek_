        ...
        @forelse ($orgs as $org)
            <div class="col-md-4 col-lg-3">
                <div class="card h-100 border-0 shadow-sm card-hover" style="border-radius: 20px; overflow: hidden;">
                    ...
                    <div style="height: 6px; background: linear-gradient(90deg, var(--gd-blue) 25%, var(--gd-red) 25% 50%, var(--gd-yellow) 50% 75%, var(--gd-green) 75%);"></div>
                    
                    <div class="card-body p-4 text-center">
                        {{-- Logo Placeholder/Avatar --}}
                        <div class="bg-light rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3 shadow-sm" style="width: 70px; height: 70px;">
                        ...
                        <a href="/organizations/{{ $org->id_org }}" class="btn btn-outline-primary btn-sm rounded-pill w-100 fw-bold">
                            Lihat Detail
                        </a>
                    </div>
                </div>
