...
<div class="container">
    ...
    <div class="row">
    {{-- Mengubah @foreach menjadi @forelse --}}
    ...
    @empty
        {{-- BLOK INI AKAN MUNCUL JIKA TASK/EVENT KOSONG --}}
        <div class="col-12">
            <div class="card p-4 shadow-sm border-0 text-muted" style="border-radius: 16px; background-color: #f8f9fa;">
